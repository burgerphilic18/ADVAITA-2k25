...
const Navbar = () => {
  ...
  return (
    <nav id="navbar" style={{opacity: navbarOpacity}} className="fixed top-0 w-full z-50 transition-all duration-300 py-2 px-4 md:px-10 lg:px-16 bg-transparent text-white flex justify-between  items-center pt-serif-regular ">
      {/* Menu Left */}
