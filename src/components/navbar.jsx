...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      className="fixed top-0 w-full z-50 transition-all duration-300 py-2 px-4 md:px-10 bg-transparent text-white flex justify-between items-center navbar-shadow"
    >
      {/* Menu Left */}
      ...
      <div className="hidden md:flex items-center gap-[4vw] lg:gap-[5vw] xl:gap-[6vw] flex-1 justify-start ">
        ...
        <a href="https://unstop.com/college-fests?searchTerm=advaita"className="text-xl lg:text-2xl xl:text-3xl hover:opacity-80 transition-opacity">REGISTER</a>
      </div>
